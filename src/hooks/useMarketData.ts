  ...
  const fetchMarketData = async (query: string) => {
    ...
    try {
      ...
      const marketData: MarketData = {
        ...
        pendingToActiveRatio: responseData.pendingToActiveRatio,
        pendingShare: responseData.pendingShare,
        ...
        marketStrength: getMarketStrength(responseData.pendingToActiveRatio),
